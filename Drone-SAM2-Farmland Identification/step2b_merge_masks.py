# -*- coding: utf-8 -*-
"""
Step2b: 将多块手动标注的农田 mask 合并为一张联合掩码
输入：E:/SAM_data/farm_masks/farm_mask_*.png
输出：E:/SAM_data/farm_masks/union_mask.png  +  E:/SAM_data/locs_union.json
"""
import json
import os
...
OUT_MASK_PATH = Path(r"E:/SAM_data/farm_masks/farm_masks_union/farm_mask_01.png")
